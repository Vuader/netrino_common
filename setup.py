...
name = str('tachyonic_netrino_common')
sep = name.find('_')
namespace = name[:sep]
module = name[sep+1:]
...
setup_dict = dict(
    ...
    entry_points={
        # 'console_scripts': [
        #     'tachyonic_netrino_common_cli = tachyonic_netrino_common.main:entry_point'
        # ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'tachyonic_netrino_common_gui = tachyonic_netrino_common.gui:entry_point'
        # ]
    }
)
